...
impl<'b> FromBytes<'b> for AvaxMessage<'b> {
    ...
    fn from_bytes_into(
        ...
        let header = pic_str!(b"\x1AMetal Signed Message:\n"!);
    ...
    fn render_item(
        ...
        match item_n {
            0 => {
                ...
                title[..label.len()].copy_from_slice(label);
                let content = pic_str!("Metal Message");
...
mod tests {
    ...
    const DATA: &str = "A MetalMessage to sign";
    const HEADER: &str = "\x1AMetal Signed Message:\n";
